    ...
    def genereazaSuccesori(self, nodCurent, tip_euristica="euristica banala"):
        ...
        for idx in range(nr_stive):  # idx= indicele stivei de pe care iau bloc
            ...
            for j in range(nr_stive):  # j = indicele stivei pe care pun blocul
                ...
                costMutareBloc = 1 + ord(bloc) - ord("a") # calculez diferenta ascii dintre a si blocul nostru pentru a stii costul mutarii
                ...
                for iStiva, stiva in enumerate(infoNod):
                    for iElem, elem in enumerate(stiva):
                        try:
                            ...
                            h += 1 # din nou, adun cu costul minim
                euristici.append(h)
                        ...
                        try:
                            ...
                            if elem != scop[iStiva][iElem]:
                                ...
                                if stiva[:iElem] != scop[iStiva][:iElem]:
                                    h += 2  # elementul de pe pozitia iElem de pe stiva iStiva este bun, dar restul stivei nu este. Adaug costul minim, adica 2 ( elementul iElem si minimul de elemente de sub el, 1)
                        except IndexError:
                            # nici macar nu exista pozitia iElem in stiva cu indicele iStiva din scop
                            h += 1
                euristici.append(h)
