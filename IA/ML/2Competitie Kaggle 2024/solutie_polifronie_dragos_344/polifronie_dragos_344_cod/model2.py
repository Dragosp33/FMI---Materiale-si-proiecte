...
from sklearn.neural_network import MLPClassifier
mlp = MLPClassifier(hidden_layer_sizes=(800, 800, 800), activation='relu', solver='adam',
alpha = 0.0001, batch_size='auto', learning_rate='constant', learning_rate_init=0.001,
power_t=0.5, max_iter = 200, shuffle = True, random_state = None, tol=0.0001,verbose=False,
momentum=0.9, early_stopping = False, validation_fraction = 0.1, n_iter_no_change=10)

#2nd version: 0.32 acc - early stop = false, 800 800, 800
...
#file1 = "/kaggle/output/kaggle/working/submission_2_poifronie_dragos.csv"
file2 = '/kaggle/working/submission_2_poifronie_dragos.csv'
fields = ['id', 'values']
